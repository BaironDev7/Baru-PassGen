...
const PasswordGenerator: React.FC = () => {
  ...
  const generatePassword = () => {
    ...
    if (includeSymbols) {
      ...
      guaranteedCharacters += symbols[Math.floor(Math.random() * symbols.length)];
    }
    ...
    <div className="flex relative justify-center items-center min-h-screen">
      <div className="p-4 mx-auto md:w-[400px] sm:w-[340px] border border-gray-800 rounded-lg fixed text-white">
        ...
        <div className="flex flex-col gap-3">
          ...
          <label className="flex items-center gap-2"><Checkbox className="text-blue-600 ring-1 ring-white checked:ring-blue-600" checked={includeSymbols} onCheckedChange={(value) => setIncludeSymbols(value as boolean)} />Símbolos</label>
